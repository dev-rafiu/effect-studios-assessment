<template>
  <header class="w-full bg-gray-50 border-b-2 border-gray-200 py-2">
    <nav class="flex justify-center items-center h-15">
      <ul class="flex gap-8 list-none m-0 p-0">
        ...
        <li class="relative">
          ...
          >
            Features <span class="text-xs text-gray-500">▼</span>
          </a>
        </li>
        <li class="relative">
          <NuxtLink
        ...
        <li class="relative">
          <a
            ...
            class="text-gray-700 no-underline text-base font-medium transition-colors duration-200 hover:text-green-700 flex items-center gap-1"
          >
            Company <span class="text-xs text-gray-500">▼</span>
          </a>
        </li>
      </ul>
    </nav>
